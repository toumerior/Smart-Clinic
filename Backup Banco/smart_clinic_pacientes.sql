...
CREATE TABLE `pacientes` (
  ...
  KEY `FK_PACIENTES_PESSOA` (`PESSOA_ID`),
  KEY `FK_PACIENTES_CONVENIOS` (`CONVENIO_ID`),
  CONSTRAINT `FK_PACIENTES_CONVENIOS` FOREIGN KEY (`CONVENIO_ID`) REFERENCES `convenios` (`CONVENIO_ID`),
  CONSTRAINT `FK_PACIENTES_PESSOA` FOREIGN KEY (`PESSOA_ID`) REFERENCES `pessoa` (`PESSOA_ID`)
