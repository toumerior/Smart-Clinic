...
<body>
	...
	<div id="main" class="container-fluid">
		...
		<form action="${pageContext.request.contextPath}/CadastrarPaciente"
			method="post">
			...
			<div class="row">
				...
				<div class="form-group col-md-2">
					<label for="campo2">Código do Convênio</label> <input type="text"
						class="form-control" name="codConvenio" id="codConvenio">
				</div>
			</div>
