...
<body>
	...
	<div id="main" class="container-fluid">
		...
		<form action="${pageContext.request.contextPath}/CadastrarPessoa"
			method="post">
			...
			<div class="row">
				...
				<div class="form-group col-md-2">
					<label for="campo3">RG</label> <input type="text"
						class="form-control" name="RG" id="RG">
				</div>

				<div class="form-group col-md-1">
					<label for="campo4">Sexo</label> <input type="text"
						class="form-control" name="sexo" id="sexo">
				</div>

				<div class="form-group col-md-2">
					<label for="campo5">Telefone</label> <input type="text"
						class="form-control" name="telefone" id="telefone">
				</div>

				<div class="form-group col-md-4">
					<label for="campo6">Endereço</label> <input type="text"
						class="form-control" name="endereco" id="endereco">
				</div>

				<div class="form-group col-md-2">
					<label for="campo7">Login</label> <input type="text"
						class="form-control" name="login" id="login">
				</div>

				<div class="form-group col-md-2">
					<label for="campo8">Senha</label> <input type="text"
						class="form-control" name="senha" id="senha">
				</div>

				<div class="form-group col-md-2">
					<label for="campo9">Nível de acesso</label> <input type="text"
						class="form-control" name="nivel" id="nivel">
				</div>
			</div>
