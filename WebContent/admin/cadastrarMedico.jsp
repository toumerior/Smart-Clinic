...
<body>
	...
	<div id="main" class="container-fluid">
		...
		<form action="${pageContext.request.contextPath}/CadastrarMedico"
			method="post">

			<div class="row">
				<div class="form-group col-md-3">
					<label for="campo1">Código da pessoa</label> <input type="text"
						class="form-control" name="codPessoa" id="codPessoa">
				</div>

				<div class="form-group col-md-2">
					<label for="campo2">CRM</label> <input type="text"
						class="form-control" name="CRM" id="CRM">
				</div>

				<div class="form-group col-md-2">
					<label for="campo3">Duração de consulta</label> <input type="text"
						class="form-control" name="duracaoConsulta" id="duracaoConsulta">
				</div>
			</div>
